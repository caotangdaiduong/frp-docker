...
[![DockerHub Badge](http://dockeri.co/image/caotangdaiduong/frp)](https://hub.docker.com/r/caotangdaiduong/frp/)
...
```sh
docker run -itd --name frps -p 7000:7000 -p 6000:6000 caotangdaiduong/frp
```
...
```sh
docker run -itd --name frpc -e MODE=client -e SERVER_ADDR=frp.example.com -e SERVER_PORT=7000 -e PROTO=tcp -e LOCAL_IP=192.168.1.20 -e LOCAL_PORT=22 -e REMOTE_PORT=6000 caotangdaiduong/frp
```
...
FRP_TOKEN | String | M8SECYUCNYWEE8L
